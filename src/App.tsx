          ...
          <section class='my-20'>
            ...
            <div class="flex flex-wrap flex-row justify-center w-fulltext-center">
              ...
              <Card
                ...
                code='https://github.com/andresgamboaa/anki-word-or-phrase-reconstruction'
              >
                <div class='mt-2 mb-6 text-left'>
              ...
              <Card
                ...
                title='recli'
                tags={['Rust', 'SQLite']}
                code='https://github.com/andresgamboaa/recli'
              >
                <div class='mt-2 mb-6 text-left'>
              ...
              <Card
                ...
                code='https://github.com/andresgamboaa/lingomark'
              >
                <div class='mt-2 mb-6 text-left'>
              ...
              <Card
                ...
                code='https://github.com/andresgamboaa/read-japanese'
              >
                <div class='mt-2 mb-6 text-left'>
              ...
              <Card
                ...
                code='https://github.com/andresgamboaa/desarrolloweb-costarica'
